...
async def cmd_status(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if u['is_subscribed']:
        ...
        await update.message.reply_text(t(uid, 'no_sub', price=f"{int(price):,}"), parse_mode=ParseMode.HTML)
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("lang_"):
        ...
        names = {'uz': "✅ O'zbek tili", 'ru': "✅ Русский язык", 'en': "✅ English language"}
        await query.edit_message_text(names.get(lang, "✅ OK"))
        return
